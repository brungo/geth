...
LAB22:    t17 = ((STD_STANDARD) + 984);
    ...
    *((unsigned int *)t43) = t30;
    ...
    t13 = (t8 + t30);
    t44 = *((int64 *)t13);
    std_textio_write8(STD_TEXTIO, t1, t12, t44, (unsigned char)0, 0, 1000000LL);
    t13 = (t0 + 17518);
    t35 = (t34 + 0U);
    t43 = (t35 + 0U);
    *((int *)t43) = 1;
...
LAB15:    t19 = ((STD_STANDARD) + 984);
    ...
    *((unsigned int *)t41) = t36;
    std_textio_write7(STD_TEXTIO, t1, t15, t16, t38, (unsigned char)0, 0);
    std_textio_write8(STD_TEXTIO, t1, t15, t7, (unsigned char)0, 0, 1000000LL);
    t16 = (t0 + 17620);
    t35 = (t38 + 0U);
    t41 = (t35 + 0U);
    *((int *)t41) = 1;
